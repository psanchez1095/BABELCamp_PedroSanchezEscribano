...
<!--Responsive CSS-->
<link rel="stylesheet"media="screen and (max-width: 2100px) and (min-width:860px)"href="css/index.css">
<link rel="stylesheet"media="screen and (max-width: 860px) and (min-width:0px)"href="css/indexLarge.css">
