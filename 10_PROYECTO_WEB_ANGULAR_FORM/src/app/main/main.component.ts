...
export class MainComponent {
  ...
  public addGame() {
    ...
    if (this.id != '' && !isNaN(parseInt(this.id)) && this.titulo != '' &&this.compania != '' && this.vMedia != '' &&!isNaN(parseInt(this.vMedia))) {
    ...
    //En caso de que algun campo este vacio y/o la valoración media sea un string
      ...
      if (this.id != '' && isNaN(parseInt(this.id))) this.errorMessage = 'El Id debe ser un número.';
      else if (this.vMedia != '' && isNaN(parseInt(this.vMedia))) this.errorMessage = 'La valoración media debe ser un número.';
